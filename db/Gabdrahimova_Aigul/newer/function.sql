/*
Функционал:
1. Выводит информацию о рейсах всех (ввиде расписание)
...
8. Продажа билетов на рейс (добавляет новый заказ на рейс в базу) 
8. Редактирование расписания (удаление и добавление) 
10. Подсчет количество забронированных и оплаченных билетов на рейс
11. Регистрация пассажиров (смена статуса пассажира)
12. Информация о билетах по фамилии клиента 
13. Информация о билете(клиенте) по номер билета
14. Выводит информацию о билетах всех (ввиде большой сводной таблицы)
*/
use `port`;
